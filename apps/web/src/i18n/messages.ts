...
const en = {
  ...
  host: {
    ...
    error: "Could not create room — the question service may be offline.",
    difficulty: "Difficulty",
    easy: "Easy",
    medium: "Medium",
    hard: "Hard",
    easyHint: "General knowledge · 15s per question",
    mediumHint: "Logic & abstract puzzles · 1 min per question",
    hardHint: "Story-based critical thinking · up to 5 min per question",
  },
  play: {
    title: "Join a game",
...
const kz: Messages = {
  ...
  host: {
    ...
    error: "Бөлме құру мүмкін болмады — сұрақ қызметі қолжетімсіз болуы мүмкін.",
    difficulty: "Деңгей",
    easy: "Оңай",
    medium: "Орташа",
    hard: "Қиын",
    easyHint: "Жалпы білім · әр сұраққа 15 сек",
    mediumHint: "Логика және абстракция · әр сұраққа 1 мин",
    hardHint: "Оқиғаға негізделген сын тұрғысынан ойлау · әр сұраққа 5 минутқа дейін",
  },
  play: {
    title: "Ойынға қосылу",
